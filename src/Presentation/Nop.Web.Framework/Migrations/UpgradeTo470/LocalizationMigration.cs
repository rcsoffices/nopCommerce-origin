    ...
    public class LocalizationMigration : MigrationBase
    {
        ...
        public override void Up()
        {
            ...
            localizationService.AddOrUpdateLocaleResource(new Dictionary<string, string>
            {
                ...
                ["Admin.Configuration.Settings.CustomerUser.AddressFormFields.DefaultCountryId.Hint"] = "Select the default country for address form fields. This can speed up the checkout process.",
                ["Admin.Configuration.Settings.CustomerUser.DefaultCountryId"] = "Default Country",
                ["Admin.Configuration.Settings.CustomerUser.DefaultCountryId.Hint"] = "Select the default country for customer form fields. This can speed up the registration process.",
            }, languageId);
